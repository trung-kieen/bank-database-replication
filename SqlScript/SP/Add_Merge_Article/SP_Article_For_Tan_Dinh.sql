...
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_TANDINH', @article = N'SP_ChuyenTien', @source_owner = N'dbo', @source_object = N'SP_ChuyenTien', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_ChuyenTien', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_TANDINH', @article = N'SP_GuiRut', @source_owner = N'dbo', @source_object = N'SP_GuiRut', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_GuiRut', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_TANDINH', @article = N'SP_TimNhanVien', @source_owner = N'dbo', @source_object = N'SP_TimNhanVien', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_TimNhanVien', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
...
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_TANDINH', @article = N'uv_SoDuTaiKhoan', @source_owner = N'dbo', @source_object = N'uv_SoDuTaiKhoan', @type = N'view schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'uv_SoDuTaiKhoan', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
