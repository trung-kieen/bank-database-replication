...
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_BENTHANH', @article = N'SP_ChuyenNhanVien_Undo', @source_owner = N'dbo', @source_object = N'SP_ChuyenNhanVien_Undo', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_ChuyenNhanVien_Undo', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_BENTHANH', @article = N'SP_Helper_IsExistEmployee', @source_owner = N'dbo', @source_object = N'SP_Helper_IsExistEmployee', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_Helper_IsExistEmployee', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_BENTHANH', @article = N'SP_Helper_MaNV_ChiNhanhKhac', @source_owner = N'dbo', @source_object = N'SP_Helper_MaNV_ChiNhanhKhac', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_Helper_MaNV_ChiNhanhKhac', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
exec sp_addmergearticle @publication = N'NGANHANG_BENTHANH', @article = N'SP_IsExistEmployee', @source_owner = N'dbo', @source_object = N'SP_IsExistEmployee', @type = N'proc schema only', @description = N'', @creation_script = N'', @pre_creation_cmd = N'drop', @schema_option = 0x0000000008000001, @destination_owner = N'dbo', @destination_object = N'SP_IsExistEmployee', @force_reinit_subscription = 1
,@force_invalidate_snapshot = 1
GO
use [NGANHANG]
