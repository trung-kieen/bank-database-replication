USE NGANHANG
GO 
CREATE OR ALTER PROCEDURE SP_ThongKeKhachHang_SongSong
AS 
BEGIN
...
-- SET @cmd  = 'INSERT INTO ##temp SELECT CMND, HO, TEN, DIACHI, PHAI, NGAYCAP, SODT, MACN FROM LINK1.NGANHANG.dbo.KhachHang';
...
-- INSERT INTO ##temp SELECT CMND, HO, TEN, DIACHI, PHAI, NGAYCAP, SODT, MACN FROM NGANHANG.dbo.KhachHang
